...
export default function InvitationSection() {
  ...
  return (
    <section style={{ background: 'var(--ink)', padding: '12rem 6vw' }}>
      <div style={{
        display: 'grid',
        ...
        <div ref={rightRef}>
          ...
          <input
            ...
            style={{
              ...
              maxWidth: 360,
              border: 'none',
              borderBottom: '1px solid rgba(245,239,228,0.25)',
            ...
            onFocus={(e) => e.currentTarget.style.borderBottomColor = 'rgba(245,239,228,0.7)'}
            onBlur={(e) => e.currentTarget.style.borderBottomColor = 'rgba(245,239,228,0.25)'}
          />
